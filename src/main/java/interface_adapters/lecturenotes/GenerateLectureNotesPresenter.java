...
/**
 * Presenter for lecture notes generation.
 */
public class GenerateLectureNotesPresenter implements GenerateLectureNotesOutputBoundary {
  ...
  /**
   * Constructs a GenerateLectureNotesPresenter with the given view model
   * and view manager.
   *
   * @param lectureNotesViewModel the lecture notes view model
